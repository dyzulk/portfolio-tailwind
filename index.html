...
<html lang="en" class="scroll-smooth">
  <head>
    <link href="https://raw.githubusercontent.com/dyzulk/dyzulk.github.io/main/favicon.png" rel="icon" sizes=”32×32″ type="image/png">
    <meta charset="UTF-8" />
    ...
    $encodedBotToken = json_encode($botToken);
  	...
  	<script>
  	// Dekodekan nilai variabel dari PHP
  	var token = <?php echo $encodedBotToken; ?>;
  	var grup = <?php echo $encodedBotGrup; ?>;
  	</script>
  </head>
  <body>
    <!-- Header Start -->
    <header class="absolute top-0 left-0 z-10 flex w-full items-center bg-transparent">
      <div class="container">
        <div class="relative flex items-center justify-between">
          <div class="px-4">
            <a href="#home" class="block py-6 text-lg font-bold text-primary">dyzulkisme</a>
          </div>
      ...
      <div class="container">
        <div class="flex flex-wrap">
          <div class="w-full self-center px-4 lg:w-1/2">
            <h1 class="text-base font-semibold text-primary md:text-xl">Halo Semua 👋, saya <span class="mt-1 block text-4xl font-bold text-dark dark:text-white lg:text-5xl">Herdy Iskandar</span></h1>
            <h2 class="mb-5 text-lg font-medium text-secondary lg:text-2xl">Student & <span class="text-dark dark:text-white">Digital Marketer</span></h2>
            <p class="mb-10 font-medium leading-relaxed text-secondary">Pentingnya eksplorasi berbagai strategi pemasaran digital untuk mencapai tujuan bisnis dan juga mengasah keterampilan dalam analisis data.<span class="font-bold text-dark dark:text-white mb-3"></span></p>
          ...
          <div class="w-full self-end px-4 lg:w-1/2">
            <div class="relative mt-10 lg:right-0 lg:mt-9">
              <img src="dist/img/dyzulk.png" alt="Muhammad Herdy Iskandar" class="relative z-10 mx-auto max-w-full" />
      ...
      <div class="container">
        <div class="flex flex-wrap">
          <div class="mb-10 w-full px-4 lg:w-1/2">
            <h4 class="mb-3 text-lg font-bold uppercase text-primary">Sekilas dari Saya</h4>
            <h2 class="mb-5 max-w-md text-3xl font-bold text-dark dark:text-white lg:text-4xl">Yuk, buat website bisnis kamu di <a href="mailto:dyzulkdeveloper@gmail.com">WithDyzulk!</a></h2>
            <p class="max-w-xl text-base font-medium text-secondary lg:text-lg">Memiliki website bisnis  bisa mengkatkan target pasar kamu loh.</p>
          </div>
          <div class="w-full px-4 lg:w-1/2">
            ...
            <p class="mb-6 text-base font-medium text-secondary lg:text-lg">
              Saya Herdy Seorang mahasiswa ITPLN asal dari Cirebon, Indonesia. Anda mungkin melihat saya di Facebook atau Instagram. Sekarang di sini kamu. Ya, saya juga menulis. Karena ada begitu banyak hal yang tidak bisa saya katakan dengan keras, namun saya selalu menemukan cara untuk mengatakannya.
            </p>
            <div class="flex items-center">
              ...
              <!-- Instagram -->
              <a
                href="https://instagram.com/dyzulk"
                target="_blank"
                class="mr-3 flex h-9 w-9 items-center justify-center rounded-full border border-slate-300 text-slate-300 hover:border-primary hover:bg-primary hover:text-white"
              >
                <svg role="img" width="20" class="fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <!-- Twitter -->
              <a
                href="https://twitter.com/dyzulk_"
                target="_blank"
                class="mr-3 flex h-9 w-9 items-center justify-center rounded-full border border-slate-300 text-slate-300 hover:border-primary hover:bg-primary hover:text-white"
              >
                <svg role="img" width="20" class="fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <!-- LinkedIn -->
              <a
                href="https://linkedin.com/in/dyzulk"
                target="_blank"
                class="mr-3 flex h-9 w-9 items-center justify-center rounded-full border border-slate-300 text-slate-300 hover:border-primary hover:bg-primary hover:text-white"
              >
                <svg role="img" width="20" class="fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="flex w-full flex-wrap justify-center px-4 xl:mx-auto xl:w-10/12">
          <div class="mb-12 p-4 md:w-1/2">
            <div class="overflow-hidden rounded-md shadow-md">
              <img src="dist/img/portfolio/5.png" alt="Landing Page" width="w-full" />
            </div>
            <h3 class="mt-5 mb-3 text-xl font-semibold text-dark dark:text-white">Blog DyzulkDeveloper</h3>
          ...
          <div class="mb-12 p-4 md:w-1/2">
            <div class="overflow-hidden rounded-md shadow-md">
              <img src="dist/img/portfolio/5.png" alt="E-Commerce" width="w-full" />
            </div>
        ...
        <form onsubmit="kirimPesan(); return false;">
          <div class="w-full lg:mx-auto lg:w-2/3">
            <div class="mb-6 w-full px-4">
              ...
              <input type="text" name="nama" id="name" class="w-full rounded-md bg-slate-200 p-3 text-dark focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary" />
            </div>
            <div class="mb-6 w-full px-4">
            ...
            <div class="mb-6 w-full px-4">
              <label for="subject" class="text-base font-bold text-primary">Subjek</label>
              <input type="text" name="subject" id="subject" class="w-full rounded-md bg-slate-200 p-3 text-dark focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary" />
            </div>
            <div class="mb-6 w-full px-4">
              <label for="message" class="text-base font-bold text-primary">Pesan</label>
              <textarea type="email" name="pesan" id="message" class="h-32 w-full rounded-md bg-slate-200 p-3 text-dark focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary"></textarea>
            </div>
            <div class="w-full px-4">
              <button type="submit" id="kirim" value="Kirim" class="w-full rounded-full bg-primary py-3 px-8 text-base font-semibold text-white transition duration-500 hover:opacity-80 hover:shadow-lg">Kirim</button>
            </div>
          </div>
        </form>
      </div>
      ...
      <div class="container">
        <div class="flex flex-wrap">
          <div class="mb-12 w-full px-4 font-medium text-slate-300 md:w-1/3">
            ...
            <p>dyzulkdeveloper@gmail.com</p>
            <p>Jl. KH. Hasbullah 45274</p>
            <p>Indramayu</p>
          </div>
        ...
        <div class="w-full border-t border-slate-700 pt-10">
          ...
          <p class="text-center text-xs font-medium text-slate-500">
            Dibuat dengan <span class="text-pink-500">❤️</span> oleh <a href="https://instagram.com/dyzulk" target="_blank" class="font-bold text-primary">myDyzulk</a>, menggunakan
